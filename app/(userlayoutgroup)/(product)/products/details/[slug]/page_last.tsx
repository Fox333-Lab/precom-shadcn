    ...
    <div className="min-h-screen">
      <section>
        <div className="flex flex-col justify-between gap-10 lg:flex-row lg:gap-14">
          <div className="flex shrink-0 grow basis-1/4 flex-col gap-6">
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <span className="font-medium">New</span>
                <H2>{productDetails.name}</H2>
                <div className="flex flex-wrap items-center">
                  <ul className="mr-2 flex lg:mb-0">
                    <li>
                      <a href="#">
                        <svg
              ...
              <Para className="text-muted-foreground lg:max-w-md">
          ...
          <Separator className="block lg:hidden lg:max-w-md" color="gray" />
          <div className="order-first flex grow basis-1/2 gap-1 lg:order-none">
            <div className="hidden gap-3 lg:grid lg:w-full lg:grid-cols-2">
              {productDetails.images &&
                productDetails.images.map((image: IImage, i: number) => (
                  <div
                    key={i}
                    className="h-fit overflow-hidden rounded-md border border-gray-200 bg-gray-50"
                  >
                    <img
          ...
          <div className="flex shrink-0 grow basis-1/4 flex-col gap-6">
              ...
              <div className="flex flex-wrap gap-1">
                {productDetails.colors.map((ci: IStyle, i: number) => {
                  ...
                  return ci.image ? (
                    ...
                    >
                      <div
                        className="h-6 w-6 rounded-full bg-red-600 bg-cover bg-center bg-no-repeat"
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex gap-1">
                ...
                <span className="flex w-full items-center justify-center px-4 text-center font-bold outline-none">
                  {pqty}
                </span>
                <Button
                  variant="outline"
