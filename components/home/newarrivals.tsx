...
const NewArrivals = () => {
  return (
    <section className="flex flex-col gap-6">
      <H3 className="text-lg font-bold md:text-2xl">New Arrivals</H3>
      ...
      <GridListWrapper>
        {Array.from({ length: 10 }).map((_, index) => (
          <div
            className="group box-border flex transform cursor-pointer flex-col gap-4 overflow-hidden transition duration-200 ease-in-out hover:-translate-y-1 md:hover:-translate-y-1.5"
            key={index}
          >
