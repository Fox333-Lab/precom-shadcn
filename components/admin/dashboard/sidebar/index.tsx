...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black-1 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      {/* <div className="flex items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5 bg-admin-logo-back/50"> */}
      <div className="flex items-center justify-center gap-2 px-6 py-4 lg:py-4 bg-admin-logo-back/50">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        Dashboard
                        {/* arrow indicator - starts */}
                        {/* <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 transition-all duration-1000 fill-current ${
                            open && "rotate-180"
                          }`}
                          width="20"
                          height="20"
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-1 ${
                                pathname === "/" && "text-white-1"
                              }`}
                            >
                              eCommerce
                            </Link>
              ...
              {/* <!-- Menu Item Sales --> */}
              {/* <!-- Menu Item Users drop --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/admin/dashboard/users" ||
                  pathname === "/admin/dashboard/admins" ||
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/admin/dashboard/users/user"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-1 ${
                                pathname.includes("/users/user") &&
                                "text-white-1"
                              }`}
                  ...
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname === "/admin/dashboard/order/list" &&
                          // ||
                          //   pathname.includes("dashboard")) &&
                          "bg-graydark dark:bg-meta-4"
                        }`}
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/admin/dashboard/order/details"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-1 ${
                                pathname.includes("/order/details") &&
                                "text-white-1"
                              }`}
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname == "/admin/dashboard/products/create" &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  {/* <svg
